...
import { convertData2 } from '../app/(dashboard)/(routes)/detection/JsonConverter';

const VideoWithOverlay2 = ({ videoSrc, convert, control }) => {
    ...
    useEffect(() => {
      ...
      const drawOverlay = () => {
        ...
        const currentData = objectData[currentTime]; 
  ...
  export default VideoWithOverlay2